            ...
            <div class="card-body">
                <form action="/admin-siswa" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="Nama"
                                placeholder="Ex : Burhanudin" name="nama" value="{{ old('nama') }}">
                            @error('nama')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="TesDIagnostik" name="tes_diagnostik" required
                                value="{{ old('tes_diagnostik') }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="TahunPelajaran" placeholder="Ex : 2021/2022"
                                name="tahun_pelajaran" required value="{{ old('tahun_pelajaran') }}">
                        </div>
                    </div>
